...
from defaults import DEFAULT_DATA_CFRL, DEFAULT_META_CFRL
from interfaces import Explainer, Explanation, FitMixin
from backends_cfrl_base import (generate_empty_condition,
                                                 get_classification_reward,
                                                 get_hard_distribution,
                                                 identity_function)
from frameworks import Framework, has_pytorch, has_tensorflow
...
if has_pytorch:
    ...
    import backends_pytorch_cfrl_base as pytorch_base_backend

if has_tensorflow:
    # import tensorflow backend
    import backends_tensorflow_cfrl_base as tensorflow_base_backend
    ...
    def __init__(self,
        ...
        **kwargs
        ...
        if self.params["backend"] == Framework.PYTORCH:
            from backends_pytorch_cfrl_base import get_device
