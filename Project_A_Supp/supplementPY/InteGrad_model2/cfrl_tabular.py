...
from backends_cfrl_tabular import (get_conditional_vector,
                                                    get_statistics, sample)
from explainers_cfrl_base import (_PARAM_TYPES, CounterfactualRL,
                                        Postprocessing)
from frameworks import has_pytorch, has_tensorflow
...
if has_pytorch:
    ...
    import backends_pytorch_cfrl_tabular as pytorch_tabular_backend

if has_tensorflow:
    # import tensorflow backend
    import backends_tensorflow_cfrl_tabular as tensorflow_tabular_backend
